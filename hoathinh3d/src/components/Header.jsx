...
export default function Header({ setIsMenuOpen, setIsSearchOpen, setIsModalOpen, isGenreOpen, setIsGenreOpen, setNoti }) {
    ...
    const [accMenuId, setAccMenuId] = useState(false);
    const handleToggleAccMenu = (id) => {
        // Nếu menu đang mở được click lại -> đóng (null), ngược lại -> mở id mới
        setAccMenuId(accMenuId === id ? null : id);
    };
    const handleToggleCollapse = () => {
        // Trình duyệt sẽ ưu tiên đổi trạng thái nút bấm trước, sau đó mới render Menu con sau một cách mượt mà
        startTransition(() => {
            setIsMenuOpen(true);
        });
    };
                ...
                <div className="row" id="headwrap">
                    ...
                    <div className="mobile-icon-menu">
                        <div className="nav-items flex">
                            ...
                            <a href="/xem-chung/" className="xc-nav-icon-btn">
                                <div>
                                    <span className="material-icons-round1 material-icons-menu">
                                        groups
                                    </span>
                                ...
                                <span className="nav-label">Xem Chung</span>
                            </a>
                            <a
                                href="#"
                                id="get-user-info"
                                ...
                                <div className="menu-menu-container">
                                    <ul id="menu-menu" className="nav navbar-nav navbar-left">
                                        ...
                                        <li className="hh3d-mi mi-genre dropdown">
                                            ...
                                            >
                                                <li><a title="Huyền Huyễn" href="https://hoathinh3d.sthuyen-huyen" onClick={(e) => { e.preventDefault(); navigate("/theloai") }}>Huyền Huyễn</a></li>
                                        ...
                                        <li className="hh3d-mi mi-movie">
                                            <a
                                                ...
                                                onClick={(e) => { e.preventDefault(); navigate("/phimle") }}
                                            >
                                                Phim Lẻ
                                            </a>
                                        </li>
                                        <li className="hh3d-mi mi-airing">
                                            <a
                                                title="&ensp;Đang Chiếu"
                                                href="https://hoathinh3d.stphim-dang-chieu"
                                                onClick={(e) => { e.preventDefault(); navigate("/dangchieu") }}
                                            >
                                            &ensp;Đang Chiếu
                                            </a>
                                        </li>
                                        ...
                                        <li className="hh3d-mi mi-completed">
                                            <a
                                                title="&ensp;Hoàn Thành"
                                                href="https://hoathinh3d.stphim-hoan-thanh"
                                                onClick={(e) => { e.preventDefault(); navigate("/hoanthanh") }}
                                            >
                                            &ensp;Hoàn Thành
                                            </a>
                                        </li>
                                        <li className="hh3d-mi mi-top">
                                            <a
                                                title="&ensp;Top 10 HH3D"
                                                href="https://hoathinh3d.stbang-xep-hang-hoat-hinh-trung-quoc"
                                                onClick={(e) => {e.preventDefault(); navigate("/top-10")}}
                                            >
                                            &ensp;Top 10 HH3D
                                            </a>
                                        </li>
                                        <li className="hh3d-mi mi-rated">
                                            <a
                                                title="&ensp;Đánh Giá Cao"
                                                href="https://hoathinh3d.sthh3d-danh-gia-cao"
                                                onClick={(e) => {e.preventDefault(); navigate("/highlyrated")}}
                                            >
                                            &ensp;Đánh Giá Cao
                                            </a>
                                        </li>
