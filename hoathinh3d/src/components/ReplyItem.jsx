...
const ReplyItem = ({ reply, parentId, onMouseEnter, onMouseLeave, onVote, onToggleReply, nextReply }) => {
    return (
        <div
        ...
        >
                        ...
                        <img
                            ...
                            onError={(e) => {
                                if (!e.currentTarget.getAttribute('data-load-error')) {
                                    ...
                                    e.currentTarget.src = e.currentTarget.getAttribute('data-default');
                                }
                            }}
                            loading="lazy"
                        />
            ...
            {reply.isReply && <CommentForm setIsOpen={nextReply.setIsOpen} setOnSelectStickerCallback={nextReply.setOnSelectStickerCallback} onAddComment={nextReply.handleAddComment} />}
