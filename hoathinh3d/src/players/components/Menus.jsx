...
// SỬA ĐỔI: Chuyển đổi đường dẫn từ '@vidstack/react/icons' sang '@vidstack/react/player/icons'
import {
  ChevronLeftIcon,
  ChevronRightIcon,
  ClosedCaptionsIcon,
...
// Lớp Tailwind CSS cho menu và menu phụ (submenu)
...
// 1. Component Nút Settings Chính
...
// 2. Menu Phụ quản lý Phụ đề (Captions)
...
// 3. Component Nút Lựa chọn (Radio Button) trong Menu
...
// 4. Component Nút bấm chuyển mục Menu Phụ
